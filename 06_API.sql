...
BEGIN
    ...
    EXEC @rc = api.Sp_ObtenerCotizacionDolar      @TipoDolar='blue',    @Verbose=@Verbose;
    IF @rc <> 0 EXEC @rc = api.Sp_ObtenerCotizacionDolar_Curl @TipoDolar='blue',    @Verbose=@Verbose;
    WAITFOR DELAY '00:00:01';

    EXEC @rc = api.Sp_ObtenerCotizacionDolar      @TipoDolar='oficial', @Verbose=@Verbose;
    IF @rc <> 0 EXEC @rc = api.Sp_ObtenerCotizacionDolar_Curl @TipoDolar='oficial', @Verbose=@Verbose;
    WAITFOR DELAY '00:00:01';

    EXEC @rc = api.Sp_ObtenerCotizacionDolar      @TipoDolar='tarjeta', @Verbose=@Verbose;
