...
-- Quitar acceso directo a datos personales crudos
DENY SELECT ON OBJECT::app.Tbl_Persona TO [administrativo_general];
...
-- Quitar acceso directo a datos personales crudos
DENY SELECT ON OBJECT::app.Tbl_Persona TO [administrativo_bancario];
...
-- Quitar acceso directo a datos personales crudos
DENY SELECT ON OBJECT::app.Tbl_Persona TO [administrativo_operativo];
