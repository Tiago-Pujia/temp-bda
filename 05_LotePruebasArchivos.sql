...
EXEC importacion.Sp_CargarConsorciosDesdeExcel
	...
	@Hoja = N'consorcios$',
	@HDR = 1,
	@LogPath = N'C:\sqlArchivos\consorcios.log',
	@Verbose = 1;
GO
...
EXEC importacion.Sp_CargarConsorcioYUF_DesdeCsv
    @RutaArchivo = N'C:\sqlArchivos\Inquilino-propietarios-UF.csv',
    @HDR         = 1,
    @LogPath     = N'C:\sqlArchivos\uf.log',
    @Verbose     = 1;
GO
...
EXEC importacion.Sp_CargarUFsDesdeTxt
    @RutaArchivo    = N'C:\sqlArchivos\UF por consorcio.txt',
    @HDR            = 1,
    @RowTerminator  = N'0x0d0a',
    @CodePage       = N'65001',
    @LogPath        = N'C:\sqlArchivos\ufs_txt.log',
    @Verbose        = 1;
GO
...
EXEC importacion.Sp_CargarUFInquilinosDesdeCsv
    @RutaArchivo   = N'C:\sqlArchivos\Inquilino-propietarios-datos.csv',
    @HDR           = 1,
    @RowTerminator = N'0x0d0a',
    @CodePage      = N'ACP',
    @LogPath       = N'C:\sqlArchivos\uf_inq.log',
    @Verbose       = 1;
GO
...
EXEC importacion.Sp_CargarGastosDesdeJson
     @RutaArchivo = N'C:\sqlArchivos\Servicios.Servicios.json',
     ...
     @LogPath     = N'C:\sqlArchivos\gastos_json.log',
     @Verbose     = 1;
GO
